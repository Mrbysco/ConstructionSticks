...
public class LanguageGenerator extends LanguageProvider {
	...
	protected void addTranslations() {
		...
		addUpgradeInfo("upgrade_replacement", "§5Replacement", "Replaces blocks with the offhand block, or random hotbar blocks when Random is on");
		...
		add("constructionstick.description.template_replacement", "The replacement upgrade allows you to exchange blocks with the block in your offhand. If Random is enabled, it instead uses random blocks from your hotbar (and offhand). This can be useful for replacing walls after placement.");
