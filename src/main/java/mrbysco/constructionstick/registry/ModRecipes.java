...
public class ModRecipes {
	...
	public static final Supplier<RecipeSerializer<SmithingApplyUpgradeRecipe>> SMITHING_UPGRADE = RECIPE_SERIALIZERS.register("smithing_upgrade", () -> SmithingApplyUpgradeRecipe.SERIALIZER);
